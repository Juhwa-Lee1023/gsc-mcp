...
This file is a quick index of the Markdown knowledge pack.

It is intentionally redundant with `README.md` so that a coding agent can discover file descriptions even if it starts from a plain directory listing.
